                  ...
                  <div className="checkoutPaymentContainer">
                    ...
                    <label>
                      ...
                      <div className="checkoutPaymentMethod">
                        ...
                        <p>
                          {' '}
                          You can pay using a standard bank check. You complete
                          the check with the correct amount and details. Our
                          team verifies the check. We process your order after
                          the check clears. This method gives you a simple and
                    ...
                    <label>
                      ...
                      <div className="checkoutPaymentMethod">
                        ...
                        <p>
                          {' '}
                          You pay in cash when your order arrives. The delivery
                          agent collects the payment at your doorstep. This
                          option helps you place orders without online payment.
                          It keeps the process simple and secure for you.{' '}
                        </p>
                      </div>
                    </label>
                    <label>
                      ...
                      <div className="checkoutPaymentMethod">
                        ...
                        <p>
                          {' '}
                          You can complete your payment through PayPal. You sign
                          in to your account and approve the transaction. PayPal
                          protects your information and gives you a fast and
