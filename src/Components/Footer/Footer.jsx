    ...
    <>
      <footer className="footer">
        <div className="footer__container">
          <div className="footer_left">
            <div className="footer_logo_container">
              <img className="logo" src={logo} alt="" Z />
            </div>

            <p>Xaids_Ecommerce Near Fruit Mandi Apple Town Nowpora Sopore</p>

            <div className="footer_address">
              <strong> sale@Xaid.com </strong>
              <strong> +91 9070467011 </strong>
            </div>
        ...
        <div className="footer_bottom">
          <p>
            © {getCurrentYear()} Xaids. All Rights Reserved | Made By{" "}
            <a
              href="https://github.com/adilamin11"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="footerLangCurrency">
            <div className="footerLang">
              ...
              <select name="language" id="language">
                ...
                <option value="Germany">Arabic</option>
